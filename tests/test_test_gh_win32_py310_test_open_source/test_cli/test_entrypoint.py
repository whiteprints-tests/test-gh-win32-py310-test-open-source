...
from test_gh_win32_py310_test_open_source import package_metadata
from test_gh_win32_py310_test_open_source.cli import __app_name__, entrypoint
...
class TestCLI:
    ...
    def test_version(cli_runner: testing.CliRunner) -> None:
        ...
        result = cli_runner.invoke(
            entrypoint.test_gh_win32_py310_test_open_source,
            ["--version"],
        )
