...
project = "test gh win32 py310-test-open-source"
...
release = metadata.version("test_gh_win32_py310_test_open_source")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-gh-win32-py310-test-open-source",
